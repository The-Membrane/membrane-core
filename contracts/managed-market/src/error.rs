...
pub enum ContractError {
    ...
    #[error("Supply cap exceeded: {balance} > {cap}")]
    SupplyCapExceeded { balance : Uint128, cap: Uint128 },

    #[error("Invalid Withdrawal")]
    InvalidWithdrawal {},

    #[error("Not enough collateral to liquidate this much debt for the position.")]
    NoLiquidatibility {},
