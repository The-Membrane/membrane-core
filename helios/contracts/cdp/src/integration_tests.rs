...
mod tests {
    ...
    mod cdp {
        ...
        fn accrue_debt() {
            ...
            assert_eq!(
                app.wrap().query_all_balances(USER).unwrap(),
                vec![coin(100000, "2nddebit"), coin(100_227, "debit")]
            );

            assert_eq!(
                app.wrap().query_all_balances(sp_addr.clone()).unwrap(),
                vec![coin(1726, "credit_fulldenom"), coin(577, "debit")]
            );
            assert_eq!(
        ...
        fn liquidate_bignums() {
            ...
            assert_eq!(
                ...
                Uint128::new(97_288_888_885_531)
            );
            ...
            assert_eq!(
                app.wrap()
                    .query_all_balances(staking_contract.clone())
                    .unwrap(),
                vec![coin(22_222_222_250, "debit")]
            );
            assert_eq!(
                app.wrap().query_all_balances(USER).unwrap(),
                vec![coin(100000, "2nddebit"), coin(444_444_545_000, "debit")]
            );
            ...
            assert_eq!(
                app.wrap().query_all_balances(lq_contract.addr()).unwrap(),
                vec![coin(2_000_000_002_775, "debit")]
            );
        }
