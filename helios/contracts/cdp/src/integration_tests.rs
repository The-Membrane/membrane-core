...
mod tests {
    ...
    fn mock_app() -> App {
            AppBuilder::new().build(|router, _, storage| {
                ...
                .unwrap();
                bank.init_balance(storage, &Addr::unchecked("bigger_bank"),  vec![coin(100_000_000_000_000, "debit"), coin(100_000_000_000_000, "double_debit"), coin(100_000_000_000_000, "lp_denom")])
                .unwrap(); 
