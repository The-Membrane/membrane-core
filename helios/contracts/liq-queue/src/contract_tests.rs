...
fn submit_bid() {
    ...
    let msg = ExecuteMsg::AddQueue {
        ...
        bid_asset: AssetInfo::NativeToken { denom: "cdl".to_string() }, //This should always be the same credit_asset but will leave open for mutability
...
fn execute_bid() {
    ...
    assert_eq!(
        ...
        vec![SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: "owner0000".to_string(),
