    ...
    mod liquidity {
        ...
        fn add_edit_remove() {
            ...
            let msg = ExecuteMsg::AddAsset { 
                asset: LiquidityInfo {
                    asset: AssetInfo::NativeToken { denom: String::from("credit_fulldenom") }, 
                    pool_ids: vec![ 1u64 ],
                },
            };
            ...
            let assets: Vec<LiquidityInfo> = app
                ...
                .query_wasm_smart(
                    ...
                    &QueryMsg::Assets { 
                        asset_info: Some( AssetInfo::NativeToken { denom: String::from("credit_fulldenom") } ), 
                        limit: None, 
                        start_after: None,
                    },
                )
            ...
            let msg = ExecuteMsg::AddAsset { 
                asset: LiquidityInfo {
                    asset: AssetInfo::NativeToken { denom: String::from("credit_two") }, 
                    pool_ids: vec![ 99u64 ],
                },
            };
            let cosmos_msg = liquidity_contract.call(msg, vec![]).unwrap();
        ...
        fn get_liquidity() {
            ...
            app
                ...
                .query_wasm_smart::<Uint128>(
                    liquidity_contract.clone().addr(),
                    &QueryMsg::Liquidity { asset: AssetInfo::NativeToken { denom: String::from("invalid") } },
                )
                .unwrap_err();
            ...
            let liquidity: Uint128 = app
                ...
                .query_wasm_smart(
                    liquidity_contract.clone().addr(),
                    &QueryMsg::Liquidity { asset: AssetInfo::NativeToken { denom: String::from("credit_fulldenom") } },
                )
                .unwrap();
