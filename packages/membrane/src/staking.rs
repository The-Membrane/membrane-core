...
use crate::types::{ Asset, StakeDeposit, FeeEvent };
...
pub enum ExecuteMsg {
    ...
    Stake { //Deposit MBRN tokens for a user
        user: Option<String>,
    },
    Unstake { //Withdraw and claim rewards
        mbrn_amount: Option<Uint128>,
    }, 
    Restake { //Restake unstak(ed/ing) MBRN
        mbrn_amount: Uint128,
    }, 
    ClaimRewards { //Claim ALL staking rewards
